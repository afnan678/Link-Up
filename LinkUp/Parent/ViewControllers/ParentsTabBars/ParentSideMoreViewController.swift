...
class ParentSideMoreViewController : UIViewController{
    let topView : UIView = {
       let view = UIView()
...
//        self.navigationController?.viewControllers.removeAll()
    ...
    func resetUserInterface(){
        ParentRecordModel.shared.studentRollNo = 0
        ParentRecordModel.shared.studentName = ""
        ParentRecordModel.shared.studentDOB = ""
        ParentRecordModel.shared.studentClass = ""
        ParentRecordModel.shared.fatherName = ""
        ParentRecordModel.shared.fatherEmail = ""
        ParentRecordModel.shared.fatherPhoneNo = ""
        ParentRecordModel.shared.address = ""
        ParentRecordModel.shared.imageURL = ""
        ParentRecordModel.shared.studentImage = nil
