//
//  DisplayParentAnnouncementCustomCell.swift
//  LinkUp
//
...
class DisplayParentAnnouncementCustomCell: UITableViewCell {
    
    static let identifier = "DisplayParentAnnouncementCustomCell"
