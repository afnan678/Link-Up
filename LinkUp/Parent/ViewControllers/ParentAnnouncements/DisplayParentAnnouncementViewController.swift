//
//  DisplayParentAnnouncementViewController.swift
//  LinkUp
//
...
class DisplayParentAnnouncementViewController : UIViewController {
    
    var announcementTable : UITableView = {
        var tble = UITableView()
        tble.register(DisplayParentAnnouncementCustomCell.self, forCellReuseIdentifier: DisplayParentAnnouncementCustomCell.identifier)
    ...
    override func viewDidLoad() {
        ...
        self.configureUI()
        FirestoreManager.shared.reteriveAllAnnouncement(role: "Parents") { success in
            if success {
...
extension DisplayParentAnnouncementViewController : UITableViewDelegate , UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        AnnouncementData.announcementList.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: DisplayParentAnnouncementCustomCell.identifier, for: indexPath) as! DisplayParentAnnouncementCustomCell
