...
class AdminSideMoreViewController : UIViewController {
    let topView : UIView = {
       let view = UIView()
...
//    lable
    ...
    var userNameLabel : UILabel = {
        ...
        var lbl = UILabel()
        lbl.translatesAutoresizingMaskIntoConstraints = false
        lbl.text = AdminData.shared.name
        lbl.textColor = .white
...
//    }()
    ...
    var profile_ImageView : UIImageView = {
        ...
        img.image = UIImage(named: "profile_pic")
...
//        title = "More"
    ...
    func resetUserInterface(){
        ...
        AdminData.shared.email = ""
        AdminData.shared.name = ""
        
        TeacherDataModelForAdmin.records.removeAll()
        TeacherDataModelForAdmin.teacherImageArray.removeAll()
        
        ClassDataModel.recordArray.removeAll()
