...
import Foundation
import UIKit
class RemoveTeacherCustomCell : UITableViewCell {
     static let identifier = "CustomTeacherRemoveCell"
...
//        view.backgroundColor = .red
    ...
    let removeTeacherButton : UIButton = {
        let btn = UIButton()
        btn.setTitle("Remove Teacher", for: .normal)
    ...
    func configureUI(){
        ...
        removeButtonBackGroundView.addSubview(removeTeacherButton)
...
//            removeTeacherButton.widthAnchor.constraint(equalTo: teacherRecordStackView.widthAnchor, multiplier: 0.7),
            removeTeacherButton.leadingAnchor.constraint(equalTo: removeButtonBackGroundView.leadingAnchor),
            removeTeacherButton.trailingAnchor.constraint(equalTo: removeButtonBackGroundView.trailingAnchor , constant: -40),
            removeTeacherButton.heightAnchor.constraint(equalTo: removeButtonBackGroundView.heightAnchor),
        ])
    }
