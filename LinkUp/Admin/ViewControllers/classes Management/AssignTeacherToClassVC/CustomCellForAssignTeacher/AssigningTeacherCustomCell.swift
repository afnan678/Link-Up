//
//  AssigningTeacherCustomCell.swift
//  LinkUp
//
...
class AssigningTeacherCustomCell : UITableViewCell {
    
    static var identifier = "AssigningTeacherCustomCell"
    ...
    var assignTeacherButton : UILabel = {
    ...
    func configureUI(){
        ...
        classNameAndTeacherNameStackView.addArrangedSubview(assignTeacherButton)
    ...
    func setRecord(obj : ClassDataModel){
        ...
        assignTeacherButton.text = obj.assignedTeacher
    }
}
